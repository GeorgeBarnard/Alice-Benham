...
<div class="homepage-body">
  ...
  <img class="upper-image" src="<?php bloginfo('template_url') ?>/img/sky1.jpg" alt="">
  <img class="background img1" src="<?php bloginfo('template_url') ?>/img/copper.jpg" alt="">
  <img class="background hide img2" src="<?php bloginfo('template_url') ?>/img/chair.jpg" alt="">
  <img class="background hide img3" src="<?php bloginfo('template_url') ?>/img/table.jpg" alt="">
  <img class="background hide img4" src="<?php bloginfo('template_url') ?>/img/shop.jpg" alt="">
...
<div class="right-text">
  ...
  <p class="paragraph paragraph-2">
   I’m a millennial based in the UK. Like many young people, I love the digital world and since leaving school I’ve made it my mission to empower business to use social media, blogging and digital content to grow their brands and customers
  </p>
 <img class="initials-img" src="<?php bloginfo('template_url') ?>/img/AB-logo.png" alt="">
</div>
</div>
</div>
